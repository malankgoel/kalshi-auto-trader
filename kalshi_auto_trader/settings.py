...
KALSHI_HTTP_TIMEOUT = _env_positive_int("KALSHI_HTTP_TIMEOUT", 20)
KALSHI_HTTP_RETRIES = _env_positive_int("KALSHI_HTTP_RETRIES", 4)
KALSHI_MARKET_PAGE_LIMIT = _env_positive_int("KALSHI_MARKET_PAGE_LIMIT", 200)
